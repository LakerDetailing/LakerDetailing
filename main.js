// ══════════════════════════════════════════════════════════════════════════
// LAKER DETAILING — RECENZIJE, GALERIJA, UPIT I LOYALTY
// Učitava se samo tamo gde ovo treba (`/` i, od faze 3, `/cenovnik`).
// Zajedničko ponašanje interfejsa (navigacija, meni, tema, tabovi, FAQ,
// otkrivanje sekcija, data-click) je u assets/js/laker-ui.js.
// ══════════════════════════════════════════════════════════════════════════
...
// stilovi su u assets/css/pocetna.css (blokovi "GALERIJA — IZLOG" i "PREGLED SLIKE...").
